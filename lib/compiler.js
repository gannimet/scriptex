...
function escapeForLatex(text) {
	return text
		...
		.replace(new RegExp('‡', 'g'), '\\ddag{}')
		.replace(new RegExp('\\u007c', 'g'), '\\textbar{}')
		.replace(new RegExp('>', 'g'), '\\textgreater{}')
		.replace(new RegExp('™', 'g'), '\\texttrademark{}')
		.replace(new RegExp('¡', 'g'), '\\textexclamdown{}')
		.replace(new RegExp('£', 'g'), '\\pounds{}')
		.replace(new RegExp('#', 'g'), '\\#{}')
		.replace(new RegExp('&', 'g'), '\\&{}')
		.replace(new RegExp('§', 'g'), '\\S{}')
		.replace(new RegExp('†', 'g'), '\\dag{}')
		.replace(new RegExp('<', 'g'), '\\textless{}')
		.replace(new RegExp('®', 'g'), '\\textregistered{}')
		.replace(new RegExp('¿', 'g'), '\\textquestiondown{}')
		.replace(new RegExp('©', 'g'), '\\copyright{}');
}
...
Compiler.prototype.write = function() {
	fs.writeFile(this.outputFile, escapeForLatex(this.tex), this.doneCallback);
}
